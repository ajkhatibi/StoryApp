...
//
//  Created by Julian Khatibi on 6/17/16.
...
class PageController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let page = page{
            ...
            storyLable.attributedText = attributedString
    ...
    override func viewWillLayoutSubviews() {
        ...
        view.addSubview(storyLable)
        storyLable.translatesAutoresizingMaskIntoConstraints = false
        NSLayoutConstraint.activateConstraints([
                storyLable.leadingAnchor.constraintEqualToAnchor(view.leadingAnchor, constant: 16.0),
                storyLable.trailingAnchor.constraintEqualToAnchor(view.trailingAnchor, constant: -16.0),
                storyLable.topAnchor.constraintEqualToAnchor(view.centerYAnchor, constant: -48.0)
            ])
